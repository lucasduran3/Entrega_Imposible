export default class Level1 extends Phaser.Scene{
    ...
    create(){
        ...
        const flowerL = this.map.addTilesetImage("flower", "flower");
        const flower2L = this.map.addTilesetImage("flower2", "flower2");
        ...
        const flowerLayer = this.map.createLayer("flower", flowerL,0,0);
        const flower2Layer = this.map.createLayer("flower2", flower2L,0,0);
